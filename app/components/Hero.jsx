  ...
  return (
    <section className="hero">
      <div className="text-center mt-8">
        <h1 className="mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold text-white"><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1ff] to-[#fff]">Hello I&apos;m </span> Mubashir</h1>
